...
void InitDefaultsOperatorSetProtoImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_onnx_2doperators_2eproto::InitDefaultsOperatorProto();
  protobuf_onnx_2doperators_2eproto::InitDefaultsFunctionProto();
  {
...
void AddDescriptorsImpl() {
  ...
  ::protobuf_onnx_2eproto::AddDescriptors();
}
...
OperatorSetProto::OperatorSetProto()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_onnx_2doperators_2eproto::InitDefaultsOperatorSetProto();
  }
  SharedCtor();
