...
void InitDefaultsConfigProto_Experimental() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsConfigProto_ExperimentalImpl);
}
...
void InitDefaultsConfigProtoImpl() {
  ...
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsConfigProto_Experimental();
  {
...
void InitDefaultsRunOptions_Experimental() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsRunOptions_ExperimentalImpl);
}
...
void InitDefaultsRunOptionsImpl() {
  ...
  protobuf_tensorflow_2fcore_2fprotobuf_2fconfig_2eproto::InitDefaultsRunOptions_Experimental();
  {
...
;
  ...
  if (this->has_experimental()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        16, *experimental_, deterministic, target);
  }
...
::google::protobuf::uint8* RunOptions::InternalSerializeWithCachedSizesToArray(
  ...
  if (this->has_experimental()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        8, *experimental_, deterministic, target);
  }
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::ConfigProto_Experimental* Arena::CreateMessage< ::tensorflow::ConfigProto_Experimental >(Arena* arena) {
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::RunOptions_Experimental* Arena::CreateMessage< ::tensorflow::RunOptions_Experimental >(Arena* arena) {
